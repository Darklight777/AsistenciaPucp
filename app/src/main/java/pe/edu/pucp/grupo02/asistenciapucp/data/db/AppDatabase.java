...
import pe.edu.pucp.grupo02.asistenciapucp.data.db.dao.TeacherAttendanceDao;
...
@Database(entities = {User.class, TeacherCurHor.class, TeacherAttendance.class, StudentAttendance.class}, version = 2, exportSchema = false)
